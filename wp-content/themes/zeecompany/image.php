<?php get_header(); ?>
	...
	<div id="wrap">
		...
		<div id="image-nav">
			...
			<span class="nav-return"><a href="<?php echo esc_url( get_permalink( $post->post_parent )); ?>" title="Return to Gallery" rel="gallery"><?php _e('Return to', 'themezee_lang'); ?> <?php echo get_the_title( $post->post_parent ); ?></a>
		</div>
