...
function squirrel_optionsframework_options_page() {
    ...
    <div class="trail-notify">
        <h1>Go Squirrel Theme PRO!</h1>
        <p>You are Using the Lite Version of Squirrel Theme. Upgrade to Pro for extra features, Home Page Slider, Contact Page Template and more. </p>
        <a href="http://www.inkthemes.com/wp-themes/squirrel-wordpress-theme/" target="blank">Upgrade to Squirrel Theme PRO →</a>
