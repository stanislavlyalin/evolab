...
<span class="category_heading"><?php single_cat_title('Current category: '); ?></span>
<?php if (have_posts()) : ?>
...
<div class="post_category"><span>In category:</span> <?php the_category(', ') ?>
<?php the_tags('<br /><span>Tags:</span>',' , ','<br />'); ?>  </div>
</div>
