...
function shortcode_member( $avatar, $anchor, $name, $content ) {
  ...
  <table class="no_border">
    <tr>
      ...
      <td><h3><a href="$site_url/about/#$anchor">$name</a> считает:</h3></td>
    </tr>
    <tr>
      <td></td>
      <td>$content</td>
...
function shortcode_elena_egorova( $atts, $content ) {
  return shortcode_member( "http://localhost/evolab/wp-content/uploads/2013/01/elena_egorova.png", "elena_egorova", "Елена Егорова", $content );
}

function shortcode_aleksey_borisov( $atts, $content ) {
  return shortcode_member( "http://localhost/evolab/wp-content/uploads/2013/01/aleksey_borisov.png", "aleksey_borisov", "Алексей Борисов", $content );
}

function shortcode_lydmila_izmestieva( $atts, $content ) {
  return shortcode_member( "http://localhost/evolab/wp-content/uploads/2013/01/lydmila_izmestyeva.png", "lydmila_izmestieva", "Людмила Изместьева", $content );
}

function shortcode_stanislav_lyalin( $atts, $content ) {
  return shortcode_member( "http://localhost/evolab/wp-content/uploads/2013/01/stanislav_lyalin.png", "stanislav_lyalin", "Станислав Лялин", $content );
}
